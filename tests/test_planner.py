...
from src.simulation.planner import Planner, ScheduledAction, Schedule


class TestPlannerMakespan:
    """Optimal makespan asseertions for test matrix."""
...
class TestPlannerSynthetic:
    ...
    def test_head_on_collision_link_cap1(
        self,
        head_on_graph,
    ) -> None:
        drones =  [
...
class TestPlannerConflictFree:
    """Verify schedule respects all capacity contraints."""
    ...
    def test_post_arrival_occupancy(
        ...
        """
        Arrived drone occupancies finite-capacity goal for all future turns.
        """
